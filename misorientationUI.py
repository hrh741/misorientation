...
class Ui_Misorientation(object):
    def setupUi(self, Misorientation):
        ...
        self.gridLayout_2.addWidget(self.dm_button, 8, 1, 1, 1)
        self.dp_button = QtGui.QPushButton(self.groupBox)
        self.dp_button.setObjectName(_fromUtf8("dp_button"))
        self.gridLayout_2.addWidget(self.dp_button, 8, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.d_entry, 8, 2, 1, 1)
        ...
        self.style_box = QtGui.QCheckBox(self.groupBox_10)
        self.style_box.setObjectName(_fromUtf8("style_box"))
        self.gridLayout_3.addWidget(self.style_box, 1, 0, 1, 1)
